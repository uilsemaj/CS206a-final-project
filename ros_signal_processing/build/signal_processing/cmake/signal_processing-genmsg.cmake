...
set(MSG_I_FLAGS "-Isignal_processing:/home/cc/ee106a/fa22/class/ee106a-agl/ros_workspaces/Github/CS206a-final-project/ros_signal_processing/src/signal_processing/msg;-Istd_msgs:/opt/ros/noetic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/cc/ee106a/fa22/class/ee106a-agl/ros_workspaces/Github/CS206a-final-project/ros_signal_processing/src/signal_processing/msg/AudioInfo.msg" NAME_WE)
add_custom_target(_signal_processing_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "signal_processing" "/home/cc/ee106a/fa22/class/ee106a-agl/ros_workspaces/Github/CS206a-final-project/ros_signal_processing/src/signal_processing/msg/AudioInfo.msg" ""
)
...
_generate_msg_cpp(signal_processing
  "/home/cc/ee106a/fa22/class/ee106a-agl/ros_workspaces/Github/CS206a-final-project/ros_signal_processing/src/signal_processing/msg/AudioInfo.msg"
  "${MSG_I_FLAGS}"
  ""
...
### Generating Messages
_generate_msg_eus(signal_processing
  "/home/cc/ee106a/fa22/class/ee106a-agl/ros_workspaces/Github/CS206a-final-project/ros_signal_processing/src/signal_processing/msg/AudioInfo.msg"
  "${MSG_I_FLAGS}"
  ""
  ${CATKIN_DEVEL_PREFIX}/${geneus_INSTALL_DIR}/signal_processing
)

### Generating Services

### Generating Module File
_generate_module_eus(signal_processing
  ${CATKIN_DEVEL_PREFIX}/${geneus_INSTALL_DIR}/signal_processing
  "${ALL_GEN_OUTPUT_FILES_eus}"
)

add_custom_target(signal_processing_generate_messages_eus
  DEPENDS ${ALL_GEN_OUTPUT_FILES_eus}
)
add_dependencies(signal_processing_generate_messages signal_processing_generate_messages_eus)

# add dependencies to all check dependencies targets
get_filename_component(_filename "/home/cc/ee106a/fa22/class/ee106a-agl/ros_workspaces/Github/CS206a-final-project/ros_signal_processing/src/signal_processing/msg/AudioInfo.msg" NAME_WE)
add_dependencies(signal_processing_generate_messages_eus _signal_processing_generate_messages_check_deps_${_filename})

# target for backward compatibility
add_custom_target(signal_processing_geneus)
add_dependencies(signal_processing_geneus signal_processing_generate_messages_eus)

# register target for catkin_package(EXPORTED_TARGETS)
list(APPEND ${PROJECT_NAME}_EXPORTED_TARGETS signal_processing_generate_messages_eus)
...
### Generating Messages
_generate_msg_nodejs(signal_processing
  "/home/cc/ee106a/fa22/class/ee106a-agl/ros_workspaces/Github/CS206a-final-project/ros_signal_processing/src/signal_processing/msg/AudioInfo.msg"
  "${MSG_I_FLAGS}"
  ""
  ${CATKIN_DEVEL_PREFIX}/${gennodejs_INSTALL_DIR}/signal_processing
)

### Generating Services

### Generating Module File
_generate_module_nodejs(signal_processing
  ${CATKIN_DEVEL_PREFIX}/${gennodejs_INSTALL_DIR}/signal_processing
  "${ALL_GEN_OUTPUT_FILES_nodejs}"
)

add_custom_target(signal_processing_generate_messages_nodejs
  DEPENDS ${ALL_GEN_OUTPUT_FILES_nodejs}
)
add_dependencies(signal_processing_generate_messages signal_processing_generate_messages_nodejs)

# add dependencies to all check dependencies targets
get_filename_component(_filename "/home/cc/ee106a/fa22/class/ee106a-agl/ros_workspaces/Github/CS206a-final-project/ros_signal_processing/src/signal_processing/msg/AudioInfo.msg" NAME_WE)
add_dependencies(signal_processing_generate_messages_nodejs _signal_processing_generate_messages_check_deps_${_filename})

# target for backward compatibility
add_custom_target(signal_processing_gennodejs)
add_dependencies(signal_processing_gennodejs signal_processing_generate_messages_nodejs)

# register target for catkin_package(EXPORTED_TARGETS)
list(APPEND ${PROJECT_NAME}_EXPORTED_TARGETS signal_processing_generate_messages_nodejs)
...
if(geneus_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${geneus_INSTALL_DIR}/signal_processing)
  # install generated code
  install(
    DIRECTORY ${CATKIN_DEVEL_PREFIX}/${geneus_INSTALL_DIR}/signal_processing
    DESTINATION ${geneus_INSTALL_DIR}
  )
endif()
if(TARGET std_msgs_generate_messages_eus)
  add_dependencies(signal_processing_generate_messages_eus std_msgs_generate_messages_eus)
endif()
...
if(gennodejs_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${gennodejs_INSTALL_DIR}/signal_processing)
  # install generated code
  install(
    DIRECTORY ${CATKIN_DEVEL_PREFIX}/${gennodejs_INSTALL_DIR}/signal_processing
    DESTINATION ${gennodejs_INSTALL_DIR}
  )
endif()
if(TARGET std_msgs_generate_messages_nodejs)
  add_dependencies(signal_processing_generate_messages_nodejs std_msgs_generate_messages_nodejs)
endif()

if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/signal_processing)
  install(CODE "execute_process(COMMAND \"/usr/bin/python3\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/signal_processing\")")
  # install generated code
  install(
