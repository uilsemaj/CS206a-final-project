waypoints = []
        ...
        while not rospy.is_shutdown():
            try:
                ...
                wpose.position.x = 0.886
                wpose.position.y = -0.1080   
                wpose.position.z = 0.344
                print(wpose.position.y)     #RH Added
                waypoints.append(copy.deepcopy(wpose))
                ...
                wpose.position.x = 0.835
                wpose.position.y = -0.431
                wpose.position.z = 0.500
                print(wpose.position.y)     #RH Added
                waypoints.append(copy.deepcopy(wpose))
                ...
                (wpose.position.x, wpose.position.y, wpose.position.z) = (0.825, -0.572, 0.498)
                print(wpose.position.x)
                waypoints.append(copy.deepcopy(wpose))

                #side 3
                (wpose.position.x, wpose.position.y, wpose.position.z) = (0.794, -0.574, 0.355)
                print(wpose.position.y)     #RH Added
                waypoints.append(copy.deepcopy(wpose))

                #side4

                (wpose.position.x, wpose.position.y, wpose.position.z) = (0.780, -0.495, 0.210)
                print(wpose.position.y)     #RH Added
                waypoints.append(copy.deepcopy(wpose))

                #back up

                (wpose.position.x, wpose.position.y, wpose.position.z) = (0.886, -0.108, 0.835)
                print(wpose.position.x)
                waypoints.append(copy.deepcopy(wpose))
