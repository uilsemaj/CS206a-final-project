...
class Controller(object):
    ...
    def step_control(self, t):
        ...
        # Integral Term
        self._IntError = self._Kw * self._IntError + error       # Kw accounts for windup error by downscaling previous errors and placing higher importance on most recent error
